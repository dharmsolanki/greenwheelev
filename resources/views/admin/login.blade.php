...
<div style="background:#fff;border-radius:18px;padding:40px;width:100%;max-width:400px;box-shadow:0 8px 40px rgba(0,0,0,.15)">
  <div style="text-align:center;margin-bottom:28px">
    <div style="width:52px;height:52px;background:linear-gradient(135deg,#00a651,#007a3d);border-radius:12px;display:flex;align-items:center;justify-content:center;font-size:26px;margin:0 auto 12px">⚡</div>
  ...
  <div style="text-align:center;margin-top:16px"><a href="{{ route('home') }}" style="color:#999;font-size:12.5px;text-decoration:none">← Back to website</a></div>
</div>
</body>
</html>
