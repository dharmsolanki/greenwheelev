  ...
  <div class="footer-inner">
    <div class="footer-grid">
      <div class="footer-brand">
        <div class="logo" style="margin-bottom:14px"><div class="logo-icon">⚡</div><div class="logo-text">Green Wheel EV<span>ELECTRIC MOBILITY</span></div></div>
        <p>Your trusted destination for electric two-wheelers, service, spare parts & dealership opportunities in Gujarat.</p>
